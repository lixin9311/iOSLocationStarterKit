...
public class GradientPathRenderer: MKOverlayPathRenderer {
  ...
  extension GradientPathRenderer {
    //MARK: Initializers
    /// Initializes a new Gradient Path Renderer from a given polyline and an array of colors
    ///
    /// - Parameters:
    ///   - polyline: The polyline to render
    ///   - colors: The colours the gardient should contain
    public convenience init(polyline: MKPolyline, colors: [UIColor]) {
    ...
    public convenience init(
      polyline: MKPolyline, colors: [UIColor], showsBorder: Bool, borderColor: UIColor
    ) {
      self.init(
        polyline: polyline, colors: colors.map(\.cgColor), showsBorder: showsBorder,
  ...
  extension GradientPathRenderer {
    ...
    ///   - polyline: The polyline to render
    ///   - colors: The colours the gardient should contain
    public convenience init(polyline: MKPolyline, colors: [NSColor]) {
      self.init(polyline: polyline, colors: colors.map(\.cgColor))
    }
    ...
    ///   - borderColor: The colour of the border
    public convenience init(
      polyline: MKPolyline, colors: [NSColor], showsBorder: Bool, borderColor: NSColor
    ) {
      self.init(
        polyline: polyline, colors: colors.map(\.cgColor), showsBorder: showsBorder,
        borderColor: borderColor.cgColor)
